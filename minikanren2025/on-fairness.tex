...
\footnotetext{There is a long line of work on type systems that ensure productivity by checking recursion is appropriately guarded in this fashion~\citetext{e.g.\ \citealp{DBLP:conf/lics/Nakano00}, \citealp{DBLP:journals/corr/abs-1208-3596},  \citealp{DBLP:conf/icfp/AtkeyM13}}.
...
Fair disjunction, then, is accomplished by bounding the work any stream does before yielding control, allowing us to fairly interleave multiple streams.
