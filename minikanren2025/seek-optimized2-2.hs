...

---------- SEEKABLE ITERATORS ----------
data Position k v = Found !k !v | Bound !(Bound k) | Done deriving Show
...
bound (Seek Done        _) = undefined --TODO: explain why this is fine
